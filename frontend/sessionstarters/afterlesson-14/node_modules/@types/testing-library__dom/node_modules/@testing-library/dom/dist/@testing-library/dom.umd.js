(function (global, factory) {
  ...
  */
  ...
  var collections = createCommonjsModule(function (module, exports) {
     ...
     */
    function (iterator, config, indentation, depth, refs, printer, // Too bad, so sad that separator for ECMAScript Map has been ' => '
  ...
  var DOMCollection = createCommonjsModule(function (module, exports) {
    ...
    var isNamedNodeMap = function (collection) {
    ...
    var serialize = function (collection, config, indentation, depth, refs, printer) {
      ...
      return (config.min ? '' : name + ' ') + (OBJECT_NAMES.indexOf(name) !== -1 ? '{' + (0, collections.printObjectProperties)(isNamedNodeMap(collection) ? Array.from(collection).reduce(function (props, attribute) {
  ...
  var DOMElement = createCommonjsModule(function (module, exports) {
    ...
    var testNode = function (val) {
      ...
      return nodeType === 1 && (/^((HTML|SVG)\w*)?Element$/.test(constructorName) || isCustomElement) || nodeType === TEXT_NODE && constructorName === 'Text' || nodeType === COMMENT_NODE && constructorName === 'Comment' || nodeType === FRAGMENT_NODE && constructorName === 'DocumentFragment';
    };
  ...
  function getJestFakeTimersType() {
    ...
    if (typeof globalObj.setTimeout.clock !== 'undefined' && typeof jest.getRealSystemTime !== 'undefined') {
      try {
        ...
        return 'modern';
      } catch (_unused) {// not using Jest's modern fake timers
      }
    }
  ...
  function _wrapNativeSuper$1(Class) {
    ...
    _wrapNativeSuper$1 = function (Class) {
  ...
  function _construct$1() {
    if (_isNativeReflectConstruct$1()) {
      ...
      _construct$1 = function (Parent, args, Class) {
        var a = [null];
        a.push.apply(a, args);
        var Constructor = Function.bind.apply(Parent, a);
        var instance = new Constructor();
  ...
  function _setPrototypeOf$1(o, p) {
    _setPrototypeOf$1 = Object.setPrototypeOf || function (o, p) {
      o.__proto__ = p;
      return o;
    };
  ...
  */
  ...
  var arrayFrom$1 = function (arrayLike
  ...
  var arrayMethodUsesToLength = function (METHOD_NAME, options) {
    ...
    return cache[METHOD_NAME] = !!method && !fails(function () {
      ...
      if (ACCESSORS) defineProperty$6(O, 1, {
        enumerable: true,
        get: thrower
      });else O[1] = 1;
  ...
  var defineProperty$9 = _defineProperty$1;

  var nativeAssign = Object.assign;
  var defineProperty$a = Object.defineProperty; // `Object.assign` method
  ...
  var objectAssign = !nativeAssign || fails(function () {
    ...
    if (descriptors && nativeAssign({
      b: 1
    }, nativeAssign(defineProperty$a({}, 'a', {
      enumerable: true,
      get: function get() {
  ...
  var arrayForEach = !STRICT_METHOD || !USES_TO_LENGTH$1 ? function (callbackfn
  /* , thisArg */
  ) {
  ...
  function _createForOfIteratorHelperLoose(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray$2(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; return function () { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } it = o[Symbol.iterator](); return it.next.bind(it); }
  ...
  function makeSuggestion(queryName, element, content, _ref) {
    ...
    var warning = '';
    var queryOptions = {};
    var queryArgs = [queryName === 'Role' || queryName === 'TestId' ? content : getRegExpMatcher(content)];
  ...
  function waitFor(callback, _ref) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
        var lastError, intervalId, observer, finished, overallTimeoutTimer, usingFakeTimers, _getWindowFromNode, MutationObserver, onDone, checkCallback, handleTimeout;
  ...
  function queryAllLabels(container) {
    return Array.from(container.querySelectorAll('label,input')).map(function (node) {
      var textToMatch = node.tagName.toLowerCase() === 'label' ? node.textContent : node.value || null; // The children of a textarea are part of `textContent` as well. We
  ...
  function queryAllByLabelText(container, text, _temp2) {
    ...
    var matchingLabelledElements = Array.from(container.querySelectorAll('*')).filter(function (element) {
      ...
      var labelsId = labelledElement.getAttribute('aria-labelledby') ? labelledElement.getAttribute('aria-labelledby').split(' ') : [];
      var labelsValue = labelsId.length ? labelsId.map(function (labelId) {
  ...
  var queryByLabelText = wrapSingleQueryWithSuggestion(makeSingleQuery(queryAllByLabelText, getMultipleError), queryAllByLabelText.name, 'query');
  ...
  function queryAllByRole(container, role, _temp) {
    ...
    if (selected !== undefined) {
      ...
      if (((_allRoles$get = lib_3.get(role)) == null ? void 0 : _allRoles$get.props['aria-selected']) === undefined) {
    ...
    if (checked !== undefined) {
      ...
      // guard against unknown roles
      if (((_allRoles$get2 = lib_3.get(role)) == null ? void 0 : _allRoles$get2.props['aria-checked']) === undefined) {
    ...
    if (pressed !== undefined) {
      ...
      // guard against unknown roles
      if (((_allRoles$get3 = lib_3.get(role)) == null ? void 0 : _allRoles$get3.props['aria-pressed']) === undefined) {
  ...
  */
  ...
  function createEvent(eventName, node, init, _temp) {
    ...
    ['dataTransfer', 'clipboardData'].forEach(function (dataTransferKey) {
